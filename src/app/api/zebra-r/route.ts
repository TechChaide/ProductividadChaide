...
import { generarZPL, generarZPL_R } from '../zebra/functions/zebraParser';
...
export async function POST(req: NextRequest) {
    try {
        ...
        if (printerIP) {
            console.log(`[API /zebra-r] Imprimiendo en red: ${printerIP}`);
            try {
                ...
                console.error('[API /zebra-r] Error en impresión de red:', error);
                return NextResponse.json({ 
        ...
        console.log('[API /zebra-r] Devolviendo ZPL para BrowserPrint');
