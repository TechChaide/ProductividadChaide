...
export default function OrderStickerReparaciones({
  //order,
  codigoBarras,
  añosGarantia,
  tipo,
  ...
  return (
    ...
    >
      <CardContent className="p-1 w-full h-full">
        ...
        <div className="grid grid-cols-2 gap-0 w-full p-1 mt-2">
          <div className="col justify-center fit-content">
            ...
            <h5 className="text-[12px]">Número de resortes: {numero_resortes}</h5>
            <h5 className="text-[12px]">Peso Máximo Individual de Soporte: {peso_maximo_individual}</h5>

            <br />
            <h5 className="text-[16px]">Condiciones de Conservación</h5>
            ...
            <h5 className="text-[18px] font-bold">Fecha: {new Date().toLocaleDateString('es-EC')} </h5>
          ...
          <div className=" items-start justify-start fit-content">
            ...
            <br />
            <br />
            <h4 className="text-[16px] font-bold">No desprender esta etiqueta del producto.</h4>
            <h4 className="text-[16px] font-bold">Hecho en Ecuador por Chaide y Chaide S.A.</h4>
