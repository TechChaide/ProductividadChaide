...
import { Linea } from 'src/app/@core/models/inventario/interfaces';
import { LineaService } from 'src/app/@shared/services/inventario/linea/linea.service';
...
export class LineaComponent implements OnInit {
  ...
  displayedColumns: string[] = ['codigo_linea', 'nombre_linea', 'estado', 'usuario_modificacion', 'fecha_modificacion', 'Acciones'];
  ...
  guardar() {
    ...
    const data = this.formulario.value as Linea;
    this.lineaService.save(data).pipe(
        tap(() => {
